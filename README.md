...
Install [docker](https://docs.docker.com/get-docker/) and [docker-compose](https://docs.docker.com/compose/install/) yourself, then run the following to set up first Odoo instance @ `localhost:10016` (default master password: `apple0110`):

``` bash
curl -s https://raw.githubusercontent.com/apple0110/odoo-16-docker-compose/master/run.sh | sudo bash -s odoo-one 10016 20016
```
and/or run the following to set up another Odoo instance @ `localhost:11016` (default master password: `apple0110`):

``` bash
curl -s https://raw.githubusercontent.com/apple0110/odoo-16-docker-compose/master/run.sh | sudo bash -s odoo-two 11016 21016
```
